...
if voices_loaded and avatars_loaded:
    ...
    with col_center_preview:
        ...
        with avatar_preview_col:
            ...
            st.markdown('<div class="avatar-preview" style="display: none;"></div>', unsafe_allow_html=True)
        ...
        with voice_preview_col:
            # Marker for CSS targeting
            st.markdown('<div class="voice-preview" style="display: none;"></div>', unsafe_allow_html=True)
